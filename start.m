close all;
clear all;
trainlength = 300; numClusters = 399;
...
srcFiles3 = dir('/Users/apple/Desktop/faces/*.jpg');  % the folder in which ur images exists
for i = 1 : trainlength
    filename = strcat('/Users/apple/Desktop/faces/',srcFiles3(i).name);
    I = imread(filename);
    if size(I,3) == 3
        I = single(rgb2gray(I));
    end
